...
PLAYER_RIGHT_CAP = MAP_RIGHT_LIMIT       ; Sprite movement caps
PLAYER_LEFT_CAP = $09                    ; Move the sprite, we scroll the screen
PLAYER_UP_CAP = $04                          
PLAYER_DOWN_CAP = MAP_DOWN_LIMIT
...
;===============================================================================
        ...
        cmp #21                         ; map = 64 tiles wide, screen = 10 tiles wide
        bne @scrollRight
